...
originDataScreen = function(data,
  ...
  # for(i in seq_len(nRef)){
    ...
    if ((ii > 1) & (ii < nTaxa)) {
      selection.i[seq_len((nPredics * (ii - 1)))] = BetaNoInt.i[seq_len((nPredics *
                                                                           (ii - 1)))]
      selection.i[(nPredics * ii + 1):nAlphaSelec] = BetaNoInt.i[(nPredics *
                                                                    (ii - 1) + 1):nAlphaNoInt]
      coef.i[seq_len((nPredics * (ii - 1)))] = EstNoInt.i[seq_len((nPredics *
                                                                     (ii - 1)))]
      coef.i[(nPredics * ii + 1):nAlphaSelec] = EstNoInt.i[(nPredics *
                                                              (ii - 1) + 1):nAlphaNoInt]
    }
    rm(BetaNoInt.i)
